                ...
                <div class="card-body">
                    <h6 class="card-title" style="color: black;">View Sale Report</h6>
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <input type="name" name="contact_person" class="form-control" style="color: black;background-color:aliceblue" value="{{ $salereports->contact_person }}">
                        </div>
                        <div class="mb-3 form-group" >
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <select class="js-example-basic-single form-select select2-hidden-accessible" name="status" style="background-color: aliceblue; color:black" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $salereports->status}}">
                              <option value="{{ $salereports->status }}">{{ $salereports->status }} </option>
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="sub_call_type" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $salereports->sub_call_type}}">
                              <option value="{{ $salereports->sub_call_type }}">{{ $salereports->sub_call_type }} </option>
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <input type="text" name="diagnoise" class="form-control" style="color: black;background-color:aliceblue" value="{{ $salereports->diagnoise}}">
                        </div>
                        <div class="mb-3 form-group" >
                            <label  class="form-label" style="color: gray;">Vendor</label>
                            <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="vendor" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{ $salereports->vendor}}">
                              <option value="{{ $salereports->vendor }}">{{ $salereports->vendor }} </option>
                        ...
                        <div class="mb-3 form-group" >
                            ...
                            <input type="text" name="address" class="form-control" style="color: black;background-color:aliceblue" value="{{ $salereports->address}}">
                        </div>
                          <div class="mb-3 form-group" >
                              <label  class="form-label" style="color: gray;">City</label>
                              <select style="background-color: aliceblue; color:black" class="js-example-basic-single form-select select2-hidden-accessible" name="city" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true"  value="{{$salereports->city  }}">
                                <option value="{{ $salereports->city }}">{{ $salereports->city }} </option>
